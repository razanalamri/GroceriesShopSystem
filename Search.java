...
public class Search {
	...
	public static void searchinOfInvoice() {
		...
		try {
			...
			int count = 0;
			String sql = "SELECT* FROM Customer INNER JOIN Item ON Customer.Item_id = Item.id where Invoice_No='"
					+ userinput + "'";
			...
			while (result.next()) {
				...
				System.out.println(Invoice_No + " " + Invoice_date + " " + Customer_Name + " " + Number_Of_Items + " "
						+ Total_Amount + " " + Balance + " " + Item_Name + " " + Unit_price + " " + Quntity + " "
						+ Qty);
