	...
	public static void ReportAllItems() {
		...
		try {
			...
			while (result.next() && count < userinput) {
				...
				System.out.println("Invoice_No: " + Invoice_No + " ,Invoice date: " + Invoice_date + " ,Customer Name: "
						+ Customer_Name + " ,Number_Of_Items: " + Number_Of_Items + " ,Total Amount: " + Total_Amount
						+ " ,Balance: " + Balance + " ,Item Name: " + Item_Name + " ,Unit price " + Unit_price
						+ " ,Quntity: " + Quntity + " ,Qty:  " + Qty);
				count++;
